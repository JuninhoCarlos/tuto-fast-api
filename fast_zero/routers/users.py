...
from fast_zero.schemas import Message, UserList, UserSchema, UserSchemaPublic
...
def get_users(session: DBSession, skip: int = 0, limit: int = 100):
...
@router.post('', status_code=HTTPStatus.CREATED, response_model=UserSchemaPublic)
def create_user(user: UserSchema, session: DBSession) -> UserSchemaPublic:
